...
// New gets a driver and an optional logging function, and returns
// a new slog-driver that prints all outgoing operations.
func New(logger *slog.Logger, ops ...Option) func(dialect.Driver) dialect.Driver {
	...
	return func(dri dialect.Driver) dialect.Driver {
		return &SlogDriver{Driver: dri, Handler: handle.driver()}
	}
}
...
func (d *SlogDriver) Exec(ctx context.Context, query string, args, v any) error {
	...
	return d.errorHandle(ctx, "Exec", d.Driver.Exec(ctx, query, args, v))
}
...
func (d *SlogDriver) ExecContext(ctx context.Context, query string, args ...any) (sql.Result, error) {
	...
	return result, d.errorHandle(ctx, "ExecContext", err)
}
...
func (d *SlogDriver) Query(ctx context.Context, query string, args, v any) error {
	...
	return d.errorHandle(ctx, "Query", d.Driver.Query(ctx, query, args, v))
}
...
func (d *SlogDriver) QueryContext(ctx context.Context, query string, args ...any) (*sql.Rows, error) {
	...
	return rows, d.errorHandle(ctx, "QueryContext", err)
}
...
func (d *SlogDriver) Tx(ctx context.Context) (dialect.Tx, error) {
	...
	return &SlogTx{Tx: tx, Handler: d.Handler.tx(), id: id, ctx: ctx}, nil
}
...
func (d *SlogDriver) BeginTx(ctx context.Context, opts *sql.TxOptions) (dialect.Tx, error) {
	...
	if err != nil {
		return nil, d.errorHandle(ctx, "BeginTx", err)
	}
	id := uuid.New().String()
...
func (d *SlogTx) Exec(ctx context.Context, query string, args, v any) error {
	...
	return d.errorHandle(ctx, "Exec", d.Tx.Exec(ctx, query, args, v))
}
...
func (d *SlogTx) Query(ctx context.Context, query string, args, v any) error {
	...
	return d.errorHandle(ctx, "Query", d.Tx.Query(ctx, query, args, v))
}
...
func (d *SlogTx) Commit() error {
	...
	return d.errorHandle(d.ctx, "Commit", d.Tx.Commit())
}
...
func (d *SlogTx) Rollback() error {
	...
	return d.errorHandle(d.ctx, "Rollback", d.Tx.Rollback())
}
